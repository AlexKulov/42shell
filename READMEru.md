...
Эта команда также загрузит все остальные подмодули.
...
В этом случае папка 42core - пустая. Далее аналогично б)  
Обратите внимание, чтобы [хэш коммита совпадал](img/DownLoadRepo3.png)
...
** Важно! В пути к 42support должна быть латиница **
...
При быстром старте было именно так, файлы ИД находились в папке 42core/InOut
(или просто ./InOut, т.к. исполняемый файл лежит в папке 42core).
Для 42shell существует папка со своими примерами - examples.  
Некотрые из них:   
- **4Mode**: Включает 4 тестовых режима: 3 одноосных (Солнце, надир и цель на Земле)
...
- **Simplest**: минимально возможный набор файлов ИД: файл спутника, файл орбиты, файл 
...
4) в командной строке ввести ../examples/Simplest
